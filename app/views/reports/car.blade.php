...
{{--            <div class="col-md-10">{{ $summary->actNum }}</div>--}}
        ...
        @foreach($act as $a)
          @if(isset($actStats[$actcount]->fieldCount))
            <div class="row account-status-link data-row report-main-page" data-status="{{ $a->actStatus->status_id }}">
                {{--<div class="col-md-12">--}}
                {{--<hr class="page-hr"/>--}}
                {{--</div>--}}
                <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ $actStats[$actcount]->totalMonths }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ $actStats[$actcount]->totalHours }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format($actStats[$actcount]->totalHours * 80, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ round($actStats[$actcount]->totalHours / $actStats[$actcount]->totalMonths, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">
                            {{ round( ($actStats[$actcount]->totalHours * 80) /  $actStats[$actcount]->totalMonths , 2)}}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format($actStats[$actcount]->costTotal, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format($actStats[$actcount]->avgChem, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format( $actStats[$actcount]->monthlyChemBudget, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format($actStats[$actcount]->chemVar, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ number_format( $actStats[$actcount]->contractBillingAmount, 2) }}</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6 col-md-3 text-itallic-bold">
                    ...
                    <div class="col-xs-6 col-md-9">
                        <div class="col-xs-3 col-md-3 text-right">{{ $actStats[$actcount]->altCost }}</div>
                    </div>
                </div>
                ...
                @if($summaryreport != 'summary')
                  @if(isset($actStats[$actcount]->fieldServe))
                    <div id="report_data">
                    @foreach($actStats[$actcount]->fieldServe as $f)
                        <div class="col-xs-12 col-md-12">
