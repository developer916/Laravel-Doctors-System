...
@section('title')
    Lake Doctors - Cancel and Complete Report
@endsection
...
@section('content')
    <div class="container">
            ...
            <div class="pull-right col-md-8" style="margin-top: 10px; text-align: right;">
                <div class="col-md-4 pull-right">
                    <label class="radio-inline">
                        <input type="radio" name="activeControls" id="inactive-radio" value="status"
                               style="margin-top:0;"> Status Date
                    </label>
                </div>
                ...
                <div class="col-md-3 pull-right">
                    <label class="radio-inline">
                        <input type="radio" name="activeControls" id="all-radio" value="name"
                               style="margin-top:0;"> Account Name
                    </label>
                </div>
                <div class="col-md-3 pull-right">
                    <label class="radio-inline">
        ...
        <div class="row">
            <hr class="page-hr"/>
            <div class="col-md-12">
                <h4><strong>Cancel and Complete Report</strong></h4>
            </div>
            <div class="col-md-12">
        ...
        <table class="table table-striped">
            ...
            <tr id="head-row">
                ...
                <th id="head-date">Status Date</th>
...
@section('scripts')
    <script src="<?php echo asset('/js/report.cancel.backend.js'); ?>" type="text/javascript"></script>
@endsection