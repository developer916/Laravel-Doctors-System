...
@section('content')
    <div class="container cpr-body">
        ...
        <div class="row"   style="font-size: 10pt;">
            <div class="col-xs-8 col-md-8">Office ID/Terr:
                <strong>{{ strtoupper($act->office->officeName->abvr) }}</strong>
            </div>
            @if(isset($act->salesmen->name))
            <div class="col-xs-4 col-md-4">Salesperson:
        ...
        <div class="row">
            <div class="col-xs-8 col-md-8">
                ...
                <div class="col-xs-12 col-md-12 no-left-padding" style="font-size: 12px;" >
                    ...
                    @if(isset( $act->location->address2 ) && $act->location->address2 )
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-md-6"  style="font-size: 12px;">
                ...
                @endif
                @if(strtoupper( $act->actType->info->name ) != 'MONTHLY')
                <div class="col-xs-12 col-md-12 no-left-padding">Frequency:&nbsp;
        ...
        <div class="dual-report print-page">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-6"  style="font-size: 12px;">
                    ...
                    @if($act->note->notes_phone)
                        <div class="col-xs-12 col-md-12">Phone:&nbsp;
                            {{ App\Helpers\PhoneNumberHelper::getNumber($act->note->notes_phone) }}<br>
                            @if( !is_null(App\Helpers\PhoneNumberHelper::getExtension($act->note->notes_phone)) )
                                <br/>
                                Ext: {{ App\Helpers\PhoneNumberHelper::getExtension($act->note->notes_phone) }}
                            @endif    
