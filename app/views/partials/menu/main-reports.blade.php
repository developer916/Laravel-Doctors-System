        <div id="myModal" class="modal fade" role="dialog"  style="position:absolute;top: 0px;left" >
          <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                <p class="modal-title">Please select account number to proceed </p>
                </div>
              </div>
...
<div class="input-group">
    <input id="report_search" type="text" class="form-control act-search" placeholder="Search by Account Number or Company Name">
    <span class="input-group-btn">
        <a id='reports-field-submit-btn' href='/account' class="btn btn-primary act-btn" type="button">View</a>
    </span>
    <div style="position:relative " id="autoDisplay" class="autoDisplay"></div>

</div><!-- /input-group -->    
<div id="tooltipFadeReport" class="tooltip bottom tooltipFadeReport" role="tooltip">
    <div class="tooltip-arrow"></div>
    <div id="auto_display_report" class="tooltip-inner auto_display_report"   style="overflow-y: scroll;"></div>
</div>
<div id="reportsPopup" class="row">
            ...
            <ul class="btn-list">
                ...
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a data-toggle="modal" href="#myModal" id="reports-field">Field Activity</a>
                    </div>
                </li>
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a target="_blank" data-toggle="modal" href="#myModal" id="reports-material">Materials Usage</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a target="_blank" data-toggle="modal" href="#myModal" id="reports-cpr">Customer Profile</a>
                    </div>
                </li>
                <li>
    ...
    <div class="no-left-padding col-md-7">
        ...
        <div class="act_preview">
            ...
            <ul>
                ...
                <li id="act_status">
                    <span id="act_preview_inactive" style='margin-right:10px' class="act_preview_inactive"><i class="status-bad fa fa-remove"></i></span>
                    <span id="act_preview_active" style='margin-right:10px' class="act_preview_active"><i class="status-ok fa fa-check-circle"></i></span>
        ...
        <div class="act_bio invis">
            ...
            <form target="_blank" id="act_bio_report" role="form" method="post" action="{{ route('act_bio') }}">
                <div class="col-md-12 margin-b-5">
                    <input id="reports_bio" type="text" name="actId" class="form-control resetInput" placeholder="Account Number"
                           value="">
                </div>
                <div class="col-md-12 margin-b-5">
                    <select id="id" name="id" class="form-control resetSelect" id="office">
