...
<div id="tooltipFadeReport" class="tooltip bottom tooltipFadeReport" role="tooltip">
    ...
    <div id="auto_display_report" class="tooltip-inner auto_display_report"></div>
</div>
            ...
            <ul class="btn-list">
                ...
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a href="#" id="reports-field">Field Activity</a>
                    </div>
                </li>
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a target="_blank" href="#" id="reports-material">Materials Usage</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div class="btn btn-primary btn-sub-menu">
                        <a target="_blank" href="#" id="reports-cpr">Customer Profile</a>
                    </div>
                </li>
                <li>
