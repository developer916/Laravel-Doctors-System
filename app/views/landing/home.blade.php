                    ...
                    <div class="hidden-xs hidden-sm col-md-5 sdg_stretch sdg_tool_panel">
                        <div class="col-md-10">
                            ...
                            <p>To view and edit Lake Doctors account information, run reports and manage workflow,
                                please sign in. If you dont have a Lake Doctors ID, you can <a href="#support" aria-controls="support" role="tab" data-toggle="tab"> request one on our support page.</a></p>
                        </div>
                        <div class="col-md-10">
